...
def doTheMath(result, inputList, testValue):
    ...
    resultC = int(str(result)+str(thing))
    if len(inputList)>0:
        return (doTheMath(resultA,copy.deepcopy(inputList),testValue)+doTheMath(resultB,copy.deepcopy(inputList),testValue)+doTheMath(resultC,copy.deepcopy(inputList),testValue))
    elif (resultA == testValue) or (resultB == testValue) or (resultC == testValue):
        return 1
    else:
        return 0
